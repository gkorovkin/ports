...
(git clone https://chromium.googlesource.com/chromium/tools/depot_tools.git /tmp/depot_tools && cd /tmp/depot_tools && git $DEPOT_TOOLS_COMMIT && git reset --hard)

export PATH="/tmp/depot_tools:$PATH"
(echo "Downloading WebRTC" && download_webrtc)
